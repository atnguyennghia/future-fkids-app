...
import 'package:swimming_pool/components/image/widgets/question_title.dart';
import 'package:swimming_pool/components/text/widgets/text_timer.dart';
...
import 'package:swimming_pool/views/flame/question_game.dart';
...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  bool isDisplayQuestion = false, isDisplayMicro = false;
  ...
  void callBackDisplayQuestionAndMicro() {
    setState(() {
  ...
  void callBackDisplayMicro(bool value) {
    setState(() {
      isDisplayMicro = value;
    });
  }
