...
import 'package:futurekids/modules/exercise/typing/widgets/answer_mixed_controller.dart';
...
class AnswerMixed extends StatelessWidget {
  final AnswerModel answer;
  final Function(String) honSoOnChanged;
  final Function(String) tuSoOnChanged;
  final Function(String) mauSoOnChanged;
  final bool readonly;

  late final AnswerMixedController controller;

  AnswerMixed(
      {Key? key,
      required this.answer,
      required this.honSoOnChanged,
      ...
      : super(key: key) {
    controller =
        Get.put(AnswerMixedController(), tag: '${questionId}_$answerIndex');
  }
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          width: 50,
          height: 50,
          decoration: BoxDecoration(border: Border.all(color: kNeutral2Color)),
          child: TextField(
            controller: controller.textEditingController1,
            readOnly: readonly,
            onChanged: (value) => honSoOnChanged(value),
